...
separation = 0.2;nanometers
noise = 0.0     ;noise standard deviation

spectrum1 = make_spectrum(lambda1, lambda2, dlambda, lambda0-separation, intensity, line_width, offset)
spectrum2 = make_spectrum(lambda1, lambda2, dlambda, lambda0+separation, intensity, line_width, offset)
lambda = spectrum1[*, 0]
spectrum = (spectrum1[*, 1] + spectrum2[*, 1])/2.0
